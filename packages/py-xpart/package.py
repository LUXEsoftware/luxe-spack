...
class PyXpart(PythonPackage):
    """Generation of particle ensembles for beam dynamics simulations (part of
    Xsuite)."""

    homepage = "https://github.com/xsuite/xpart"
    url = "https://github.com/xsuite/xpart/archive/refs/tags/v0.23.18.tar.gz"

    license("Apache-2.0")

    version("0.23.18", sha256="202ca7dc70fcb2fe7d8c5fd29904e5fa415c44e8257d6dde900587bd3c7328c6")
